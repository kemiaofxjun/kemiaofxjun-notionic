const BLOG = {
  ...
  socialLink: {
    twitter: 'https://twitter.com/kemiaofxjun',
    github: 'https://github.com/kemiaofxjun',
    telegram: 'https://t.me/KemiaoJun'
  },
  seo: {
    keywords: ['Notionic', 'kemiao', 'Blog'],
    googleSiteVerification: '' // Remove the value or replace it with your own google site verification code
  },
  notionPageId: process.env.NOTION_PAGE_ID, // DO NOT CHANGE THIS! Edit .env file!
  notionSpacesId: process.env.NOTION_SPACES_ID, // DO NOT CHANGE THIS! Edit .env file!
  notionAccessToken: process.env.NOTION_ACCESS_TOKEN, // Useful if you prefer not to make your database public
  notionDomain: 'caring-cayenne-675.notion.site',
  telegramToken: process.env.TELEGRAM_TOKEN, // The token of your Telegram bot
  telegramChatId: '8416977177', // The chat id of your Telegram bot
  telegramChannelUrl: 'https://t.me/kemiaofx_me', // The link of your Telegram channel
  telegramChannelName: '克喵分享', // The name of your Telegram channel
  ...
  comment: {
    ...
    utterancesConfig: {
      repo: 'kemiaofxjun/kemiaofxjun-notionic'
    }
  },
